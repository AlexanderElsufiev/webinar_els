...
insert into l3_prig.prig_work(
	rez,nom_bil,nom_mar,nom_dat,YYYYMM,date_zap,part_zap,date_beg,date_end,date_pr,id,doc_num,request_num,TERM_DOR,term_pos,term_trm,agent,subagent,chp,stp,stp_reg,--prig_cost2_nod
	sto,stn,sto_reg,stn_reg,srasst,k_pas,srok_bil,srok_mon,flg_bag,FLG_tuda_obr,flg_rab_day,kol_bil,k_bil,plata,poteri,perebor,kom_sbor,
	nom,reg,d_plata,d_poteri,sf_pas,kol_pas,
	...
	bag_vid,bag_ves,proc_lgt,ABONEMENT_TYPE,TRAIN_CATEGORY,TRAIN_NUM,prod,flg_sbor,flg_bil_sbor,
...
(select distinct date_zap,part_zap from  l3_prig.prig_times  where oper='dannie' and substr(shema,5,4)='prig'
  --where date_zap= '2023-01-23'     
),

prig_main as(select
--REQUEST_NUM,TERM_TRM,ARXIV_CODE,REPLY_CODE,REQUEST_TIME,ELS_CODE,PAYAGENT_ID,WEB_ID,TICKET_SER,TICKET_NUM,
...
ID,DOC_NUM,request_num,row_number() over (order by id,doc_num) as idd,
YYYYMM,REQUEST_DATE as date_zap,TERM_POS,TERM_DOR,term_trm,OPERATION_DATE as date_pr,TICKET_BEGDATE as date_beg,TRAIN_CATEGORY,TRAIN_NUM,
...
case when web_id='' then '-1' else web_id end as web_id,
...
fee_sum*(case when oper_g='G' then -1 else 1 end) as kom_sbor,	
...
from rawdl2.l2_prig_cost where REQUEST_DATE in(select date_zap from dates)   
),

prig_fio as
(select ID,DOC_NUM,surname||' '||initials as fio,
	dependent_surname||' '||dependent_initials as fio_2,
	bilgroup_code||bilgroup_secur as bilgroup,
	ticket_ser||cast(ticket_num as dec(7)) as ticket,
	benefit_doc,employee_unit as benefit_podr,snils
	from rawdl2.l2_prig_adi where REQUEST_DATE in(select date_zap from dates)   
),
...
klass,kod_lgt,lgt_reg,flg_bag,bag_vid,bag_ves,FLG_tuda_obr,flg_rab_day,proc_lgt,ABONEMENT_TYPE,k_pas,srok_bil,srok_mon,TRAIN_CATEGORY,TRAIN_NUM,prod,flg_sbor,
 id,doc_num from
(select flg_ruch,request_type,request_subtype,web_id,vid_rasch,FLG_CHILD,flg_voin,FLG_MILITARY,flg_lgt,FLG_BSP,FLG_SO,FLG_NU,FLG_TT,
klass,kod_lgt,lgt_reg,flg_bag,bag_vid,bag_ves,FLG_tuda_obr,flg_rab_day,proc_lgt,ABONEMENT_TYPE,k_pas,srok_bil,srok_mon,TRAIN_CATEGORY,TRAIN_NUM,prod,flg_sbor,
...
klass,kod_lgt,lgt_reg,flg_bag,bag_vid,bag_ves,FLG_tuda_obr,flg_rab_day,proc_lgt,ABONEMENT_TYPE,k_pas,srok_bil,srok_mon,TRAIN_CATEGORY,TRAIN_NUM,prod,flg_sbor) as midd
...
klass,kod_lgt,lgt_reg,flg_bag,bag_vid,bag_ves,FLG_tuda_obr,flg_rab_day,proc_lgt,ABONEMENT_TYPE,k_pas,srok_bil,srok_mon,TRAIN_CATEGORY,TRAIN_NUM,prod,flg_sbor,'B' as flg_bil_sbor
 from bil_
 union all
 select  id,doc_num,flg_ruch,request_type,request_subtype,web_id,vid_rasch,FLG_CHILD,flg_voin,FLG_MILITARY,flg_lgt,FLG_BSP,FLG_SO,FLG_NU,FLG_TT,
klass,kod_lgt,lgt_reg,flg_bag,bag_vid,bag_ves,FLG_tuda_obr,flg_rab_day,proc_lgt,ABONEMENT_TYPE,k_pas,srok_bil,srok_mon,TRAIN_CATEGORY,TRAIN_NUM,prod,flg_sbor,'S' as flg_bil_sbor
...
all_bil as 
(select flg_ruch,request_type,request_subtype,web_id,vid_rasch,FLG_CHILD,flg_voin,FLG_MILITARY,flg_lgt,FLG_BSP,FLG_SO,FLG_NU,FLG_TT,
klass,kod_lgt,lgt_reg,flg_bag,bag_vid,bag_ves,FLG_tuda_obr,flg_rab_day,proc_lgt,ABONEMENT_TYPE,k_pas,srok_bil,srok_mon,TRAIN_CATEGORY,TRAIN_NUM,prod,flg_sbor,flg_bil_sbor,
...
klass,kod_lgt,lgt_reg,flg_bag,bag_vid,bag_ves,FLG_tuda_obr,flg_rab_day,proc_lgt,ABONEMENT_TYPE,k_pas,srok_bil,srok_mon,TRAIN_CATEGORY,TRAIN_NUM,prod,flg_sbor,flg_bil_sbor) as b),
...
(select id,doc_num,idd,nom_dat,c.date_beg,mplus_dat+c.date_beg as date_end,date_pr from prig_main as c join
...
prig_main_bil as
(select a.ID,a.doc_num,request_num,idd,YYYYMM,date_zap,nom_bil,TERM_DOR,term_pos,term_trm,agent,chp,stp,stp_reg,
...
select 4 as rez,NULL as nom_bil,0 as nom_mar,nom_dat,0 as YYYYMM,/*NULL as date_zap,*/date_beg,date_end,date_pr,
 id,doc_num,0 request_num,NULL as TERM_DOR,NULL as term_pos,NULL as term_trm,
 ...
 0 as plata,0 as poteri,0 as perebor,0 as kom_sbor,0 as nom,0 as reg,0 as d_plata,0 as d_poteri,0 as sf_pas,0 as kol_pas,
 ...
 NULL as proc_lgt,NULL as ABONEMENT_TYPE,NULL as TRAIN_CATEGORY,NULL as TRAIN_NUM,NULL as prod,NULL as flg_sbor,NULL as flg_bil_sbor,
...
select   --расписывание уникальных дат  
 ...
 0 as plata,0 as poteri,0 as perebor,0 as kom_sbor,0 as nom,0 as reg,
 ...
 NULL as bag_vid,0 as bag_ves,0 as proc_lgt,NULL as ABONEMENT_TYPE,NULL as TRAIN_CATEGORY,NULL as TRAIN_NUM,NULL as prod,NULL as flg_sbor,NULL as flg_bil_sbor,
...
select 2 as rez,nom_bil,0 as nom_mar,NULL as nom_dat,0 as YYYYMM,/*date_zap,*/NULL as date_beg,NULL as date_end,NULL as date_pr,
 id,doc_num,0 as request_num,NULL as TERM_DOR,NULL as term_pos,NULL as term_trm,
 0 as agent,0 as chp,0 as stp,0 as stp_reg,0 as sto,0 as stn,0 as sto_reg,0 as stn_reg,0 as srasst,
 k_pas,srok_bil,srok_mon,flg_bag,FLG_tuda_obr,flg_rab_day,0 as kol_bil,0 as k_bil,0 as plata,0 as poteri,0 as perebor,0 as kom_sbor,
 0 as nom,0 as reg,0 as d_plata,0 as d_poteri,0 as sf_pas,0 as kol_pas,
...
klass,kod_lgt,lgt_reg,bag_vid,bag_ves,proc_lgt,ABONEMENT_TYPE,TRAIN_CATEGORY,TRAIN_NUM,prod,flg_sbor,flg_bil_sbor,
 0 as marshr,NULL as st1,NULL as st2,NULL as rst,NULL as sto_zone,NULL as stn_zone,NULL as sti,NULL as sti_zone,
 NULL as dor,NULL as lin,
 NULL as fio,NULL as fio_2,NULL as snils,NULL as ticket,NULL as benefit_doc,NULL as benefit_podr,NULL as bilgroup 
 from new_bil_zapis
...
select 3 as rez,nom_bil,0 as nom_mar,NULL as nom_dat,YYYYMM,/*date_zap,*/NULL as date_beg,NULL as date_end,NULL as date_pr,
 id,doc_num,request_num,TERM_DOR,term_pos,term_trm,
 ...
 plata,poteri,perebor,kom_sbor,0 as nom,0 as reg,0 as d_plata,0 as d_poteri,0 as sf_pas,0 as kol_pas,
 NULL as flg_ruch,0 as request_type,0 as request_subtype,NULL as web_id,NULL as vid_rasch,NULL as FLG_CHILD,NULL as flg_voin,NULL as FLG_MILITARY,NULL as flg_lgt,NULL as FLG_BSP,
 NULL as FLG_SO,NULL as FLG_NU,NULL as FLG_TT,NULL as klass,NULL as kod_lgt,NULL as lgt_reg,NULL as bag_vid,NULL as bag_ves,
 NULL as proc_lgt,NULL as ABONEMENT_TYPE,NULL as TRAIN_CATEGORY,NULL as TRAIN_NUM,NULL as prod,NULL as flg_sbor,NULL as flg_bil_sbor,
 0 as marshr,NULL as st1,NULL as st2,NULL as rst,NULL as sto_zone,NULL as stn_zone,NULL as sti,NULL as sti_zone,
...
select 5 as rez,NULL as nom_bil,0 as nom_mar,NULL as nom_dat,0 as YYYYMM,/*NULL as date_zap,*/NULL as date_beg,NULL as date_end,NULL as date_pr,
 ...
 0 as plata,0 as poteri,0 as perebor,0 as kom_sbor,nom,regg as reg,d_plata,d_poteri,0 as sf_pas,0 as kol_pas,
 NULL as flg_ruch,0 as request_type,0 as request_subtype,NULL as web_id,NULL as vid_rasch,NULL as FLG_CHILD,NULL as flg_voin,NULL as FLG_MILITARY,NULL as flg_lgt,NULL as FLG_BSP,
 NULL as FLG_SO,NULL as FLG_NU,NULL as FLG_TT,NULL as klass,NULL as kod_lgt,NULL as lgt_reg,NULL as bag_vid,NULL as bag_ves,
 NULL as proc_lgt,NULL as ABONEMENT_TYPE,NULL as TRAIN_CATEGORY,TRAIN_NUM,NULL as prod,NULL as flg_sbor,NULL as flg_bil_sbor,
...
select   --расписывание фамилии для реестра
 ...
 0 as srok_mon,NULL as flg_bag,NULL as FLG_tuda_obr,NULL as flg_rab_day,0 as kol_bil,0 as k_bil,
 0 as plata,0 as poteri,0 as perebor,0 as kom_sbor,0 as nom,0 as reg,
 0 as d_plata,0 as d_poteri,0 as sf_pas,0 as kol_pas,
 NULL as flg_ruch,0 as request_type,0 as request_subtype,NULL as web_id,NULL as vid_rasch,NULL as FLG_CHILD,0 as flg_voin,NULL as FLG_MILITARY,NULL as flg_lgt,
 NULL as FLG_BSP,NULL as FLG_SO,NULL as FLG_NU,NULL as FLG_TT,NULL as klass,0 as kod_lgt,0 as lgt_reg,
...
/**/
select rez,nom_bil,nom_mar,nom_dat,YYYYMM,date_zap,part_zap,date_beg,date_end,date_pr,id,doc_num,request_num,TERM_DOR,term_pos,term_trm,agent,0 as subagent,chp,stp,stp_reg,
	sto,stn,sto_reg,stn_reg,srasst,k_pas,srok_bil,srok_mon,flg_bag,FLG_tuda_obr,flg_rab_day,kol_bil,k_bil,plata,poteri,perebor,kom_sbor,
	nom,reg,d_plata,d_poteri,sf_pas,kol_pas,
	flg_ruch,request_type,request_subtype,web_id,vid_rasch,FLG_CHILD,flg_voin,FLG_MILITARY,flg_lgt,
	FLG_BSP,FLG_SO,FLG_NU,FLG_TT,klass,kod_lgt,lgt_reg,
...
-- INSERT 0 574398    INSERT 0 277    INSERT 0 574121
/*
ИЮНЬ 1941 ОКОНЧАТЕЛЬНЫЙ ДИАГНОЗ. СОЛОНИН. ЧИТАТЬ!!!

ИНФОРМАЦИЯ:   Начата первая часть обогащения За 2021-08-02 дату 4 порция
ИНФОРМАЦИЯ:  ШАГ 1. Выбрано 1417537 записей. За 2021-08-02 дату 4 порция
ИНФОРМАЦИЯ:   Начата первая часть обогащения За 2021-08-03 дату 5 порция, пассажиры дальние
ИНФОРМАЦИЯ:  ШАГ 1. Выбрано 429 записей. За 2021-08-03 дату 5 порция, пассажиры дальние
ИНФОРМАЦИЯ:  ШАГ 2. Выбрано 714468 записей. За 2021-08-03 дату 5 порция
ИНФОРМАЦИЯ:   ШАГ 3. Выбрано 460700 записей. За 2021-08-03 дату 5 порция
ИНФОРМАЦИЯ:   ШАГ 4. ЗАПИСАНО В БАЗУ ДАТ 10403 записей. За 2021-08-03 дату
ИНФОРМАЦИЯ:   ШАГ 4. ЗАПИСАНО В БАЗУ БИЛЕТОВ 1295 записей. За 2021-08-03 дату
ИНФОРМАЦИЯ:   ШАГ 4. ЗАПИСАНО В БАЗУ ПЕРЕГОНОВ 0 записей. За 2021-08-03 дату
ИНФОРМАЦИЯ:   ШАГ 4. ЗАПИСАНО В БАЗУ МАРШРУТОВ 99 записей. За 2021-08-03 дату
ИНФОРМАЦИЯ:   ШАГ 4. ЗАПИСАНО В БАЗУ ОШИБОК МАРШРУТОВ 6 записей. За 2021-08-03 дату
ИНФОРМАЦИЯ:   ШАГ 4. ЗАПИСАНО В БАЗУ ОБОГАЩЕНИЯ 365235 записей. За 2021-08-03 дату
ИНФОРМАЦИЯ:   Начата агрегация постанционная За 2021-08-03 дату 5 порция



 select * from l3_prig.prig_times where part_zap in(4,5) order by time
