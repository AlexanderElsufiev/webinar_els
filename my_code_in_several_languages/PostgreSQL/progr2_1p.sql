...
(select date_zap,part_zap,dann,libr,shema,current_date as date,substr(cast(current_time as char(50)),1,12) as time 
 from  l3_prig.prig_times where dann='prig' and oper='dannie' and substr(shema,5,4)='pass')
select time,date,dann,libr,'prig_work 2_1p_beg' as oper,
...
--  select * from rawdl2.l2_pass_main  where no_use is not null limit 100
...
(select distinct date_zap,part_zap,min_id,max_id from  l3_prig.prig_times where dann='prig' and oper='dannie' and substr(shema,5,4)='pass'),
...
select time,date,dann,libr,'prig_work 2_1p_rez' as oper,
