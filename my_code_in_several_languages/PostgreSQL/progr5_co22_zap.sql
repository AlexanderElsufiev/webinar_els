...
--  CREATE SCHEMA l4_prig AUTHORIZATION asul;




/*  --выдача итогов на печать
 select * from l4_prig.prig_co22_t1 order by p2 ;
 select * from l4_prig.prig_co22_t2 order by p3,p4;
 select * from l4_prig.prig_co22_t3 order by p3,p4;
 select * from l4_prig.prig_co22_t4 order by p3,p4; -- ошибка пустые значения суммм
 select * from l4_prig.prig_co22_t5;
 select * from l4_prig.prig_co22_t6 order by p3,p4;

*/


--select * from l4_prig.prig_co22_t1 where request_num in(  9730 , 28276      )  order by p2 ;

/*
delete from l4_prig.prig_co22_t0;
delete from l4_prig.prig_co22_t1;
delete from l4_prig.prig_co22_t2;
delete from l4_prig.prig_co22_t3;
delete from l4_prig.prig_co22_t4;
delete from l4_prig.prig_co22_t5;
delete from l4_prig.prig_co22_t6;
*/

/* СОЗДАНИЕ ТАБЛИЦ ОТЧЁТА ЦО-22	* /
DROP TABLE l4_prig.prig_co22_t0;
DROP TABLE l4_prig.prig_co22_t1;
DROP TABLE l4_prig.prig_co22_t2;
DROP TABLE l4_prig.prig_co22_t3;
DROP TABLE l4_prig.prig_co22_t4;
DROP TABLE l4_prig.prig_co22_t5;
DROP TABLE l4_prig.prig_co22_t6;



-------------------------------

CREATE TABLE l4_prig.prig_co22_t0
(id bigint,request_num dec(7),date_zap date,
...
ALTER TABLE l4_prig.prig_co22_t0 OWNER to asul;
GRANT ALL ON TABLE l4_prig.prig_co22_t0 TO asul;

-------------------------------
CREATE TABLE l4_prig.prig_co22_t1
(id bigint,request_num dec(7),date_zap date,
 p1 char(4),p2 integer,p3 char(4), p4 char(2),p5 char(3),p6 char(3),p7 char(3),p8 char(9),p9 char(9),p10 char(2),
 p11 char(5),p12 char(4),p13 char(3),p14 char(2),p15 char(7),p16 char(2),p17 char(5),p18 char(3),p19 char(1),p20 char(2),
 p21 char(1),p22 char(1),p23 char(1),p24 char(4),p25 char(1),p26 char(2),p27 char(3),p28 char(2),p29 char(2),p30 char(5),
...
ALTER TABLE l4_prig.prig_co22_t1 OWNER to asul;
GRANT ALL ON TABLE l4_prig.prig_co22_t1 TO asul;

-----------------------------
CREATE TABLE l4_prig.prig_co22_t2
( p1 char(4),p2 char(3),p3 integer,p4 smallint,p5 char(3),p6 char(2),p7 smallint
) TABLESPACE pg_default;
ALTER TABLE l4_prig.prig_co22_t2 OWNER to asul;
GRANT ALL ON TABLE l4_prig.prig_co22_t2 TO asul;


------------------------------
CREATE TABLE l4_prig.prig_co22_t3
( p1 char(4),p2 char(3),p3 integer,p4 smallint,p5 char(2),p6 char(5),p7 smallint
) TABLESPACE pg_default;
ALTER TABLE l4_prig.prig_co22_t3 OWNER to asul;
GRANT ALL ON TABLE l4_prig.prig_co22_t3 TO asul;


------------------------------
CREATE TABLE l4_prig.prig_co22_t4
( p1 char(4),p2 char(3),p3 integer,p4 smallint,p5 char(3),p6 char(5),p7 dec(11),p8 dec(11), p9 smallint
) TABLESPACE pg_default;
ALTER TABLE l4_prig.prig_co22_t4 OWNER to asul;
GRANT ALL ON TABLE l4_prig.prig_co22_t4 TO asul;


------------------------------
CREATE TABLE l4_prig.prig_co22_t5
( p1 char(4),p2 char(3),p3 integer,p4 integer,p5 integer,p6 dec(13),p7 dec(15),p8 dec(15),p9 dec(15),p10 dec(15)
) TABLESPACE pg_default;
ALTER TABLE l4_prig.prig_co22_t5 OWNER to asul;
GRANT ALL ON TABLE l4_prig.prig_co22_t5 TO asul;


------------------------------
CREATE TABLE l4_prig.prig_co22_t6
( p1 char(4),p2 char(3),p3 integer,p4 smallint,p5 char(2),p6 integer,p7 smallint
) TABLESPACE pg_default;
ALTER TABLE l4_prig.prig_co22_t6 OWNER to asul;
GRANT ALL ON TABLE l4_prig.prig_co22_t6 TO asul;
...
----- itog_plat_     --------- from prig1 

/**/
--- ТАБЛИЦА 1
insert into l4_prig.prig_co22_t0 
(id,date_zap,request_num,
...
prig as
(select row_number() over (order by id,doc_num,nom_bil) as nom_str,id,doc_num,request_num,
 ...
 from l3_prig.prig_itog where --date_zap>='2023-03-15'  --'2023-01-01'  --'2023-02-20'  --'2022-11-29' -- '2023-01-23'             --'2023-01-23'     --'2022-11-29' --  '2022-10-11'  '2022-10-04' 
 		yymm=202303
...
(select date_pr,date_beg,a.nom_dat,plus_dat,kpas_day,date_beg+plus_dat as date_otpr
 from dat1 as a, l3_prig.prig_dats as b where a.nom_dat=b.nom_dat and kpas_day!=0), -- as a),
...
mar as
 (select nom_mar,max_nom,sto,stn,srasst,sto_dor,stn_dor,sto_otd,stn_otd,sto_reg,stn_reg,mcd_rst,mcd_1,mcd_2,  
...
--case when FLG_OFFICIAL_BENEFIT in ('Д','Ф') then '1' else FLG_OFFICIAL_BENEFIT end as flg_zd_fpk_f
 ...
 from l3_prig.prig_bil as a left join nsi.site as b on a.web_id=b.idsite and current_date between datan and datak 
),
...
itog1 as
(select a.date_zap,
 a.id,a.doc_num,request_num,a.nom_mar,
...
(select id,request_num,date_zap,nom_mar,tab_1,--row_number() over (order by nom_str_2_) as nom_str_2, 
...
(select request_num,date_zap,nom_mar,
 ...
 flg_zd_fpk_58,flg_zd_fpk_f_59,subagent_60,mcd_61,mcd_rst_62,mcd_vid_63,  
 min(id) as id,min(nom_str_2) as nom_str_2_,
...
from itog1 group by request_num,date_zap,nom_mar,
 tab_1,year_3,month_4,kod_vc_5,kod_dor_pr_6,kod_dor_of_7,stp_8,chp_9,stp_reg_10,
 stp_okato_11,dt_otp_12,sto_dor_13,sto_otd_14,sto_15,sto_reg_16,sto_oksto_17,sto_nopr_18,kateg_pzd_19,klass_20, 
 vid_bil_21,prizn_pas_22,tarif_23,kod_lgt_24,vid_rasch_25,flg_otch_26,stn_dor_27,stn_otd_28,stn_reg_29,stn_okato_30,
 stn_nopr_31,srasst_32,vid_oforml_52,agent_53,stn_54,abonement_tip_55,srok_abon_56,bag_vid_57,
...
(select id,date_zap,request_num,nom_mar,tab_1,nom_str_2,  
 year_3,month_4,kod_vc_5,kod_dor_pr_6,kod_dor_of_7,stp_8,chp_9,stp_reg_10,
 stp_okato_11,dt_otp_12,sto_dor_13,sto_otd_14,sto_15,sto_reg_16,sto_oksto_17,sto_nopr_18,kateg_pzd_19,klass_20, 
 vid_bil_21,prizn_pas_22,tarif_23,kod_lgt_24,vid_rasch_25,flg_otch_26,stn_dor_27,stn_otd_28,stn_reg_29,stn_okato_30,
 stn_nopr_31,srasst_32,
...
itog_mar_otd as
(select distinct 'tab2' as tab_1,kod_vc_5 as kod_vc_2,nom_str_2 as nom_str_3,nnom as nom_4,dor as dor_5,otd as otd_6,rst as rst_7
...
itog_mar_reg as
(select distinct 'tab3' as tab_1,kod_vc_5 as kod_vc_2,nom_str_2 as nom_str_3,nnom as nom_4,reg as reg_5,okato as okato_6,rst as rst_7
...
itog_mar_dcs as
(select distinct 'tab6' as tab_1,kod_vc_5 as kod_vc_2,nom_str_2 as nom_str_3,nnom as nom_4,dor as dor_5,dcs as dcs_6,rst as rst_7
...
itog2_plat_ as  --разбивка денег ПРИБЛИЖЁННАЯ!!!
  (select nom_mar,nom_reg,kod_vc_2,nom_str_3,dor,okato,--plata,poteri,--nom_plat,
   sum(dd_plata) as d_plata,sum(dd_poteri) as d_poteri,sum(rst) as rst
   from 
  (select *,
  ...
  from
  (select nom_str_2 as nom_str_3,kod_vc_5 as kod_vc_2,a.nom_mar,nom_plat,nom_pl,nom_reg,reg,dor,okato,rst,sd_plata,s_plata,sd_poteri,s_poteri,s_rst,p_rst,--plata,poteri,
  ...
  group by nom_mar,nom_reg,kod_vc_2,nom_str_3,dor,okato--,plata,poteri
  ),


itog_plat as
  (select 'tab4' as tab_1,kod_vc_2,nom_str_3,nom_reg as nom_4,dor as dor_5,okato as okato_6,
   d_plata as d_plata_7,d_poteri as d_poteri_8,rst as rst_9
   from  itog2_plat_),


itog_5 as
(select 'tab5' as tab_1,kod_vc_5 as kod_vc_2,kol1 as kol1_3,kol2 as kol2_4,kol3 as kol3_5,kol_pas as kol_pas_6,0 as sum_7,0 as sum_8,plata as plata_9,poteri as poteri_10
 from 
 (select kod_vc_5,count(*) as kol1,sum(kol_pas_33) as kol_pas,sum(plata_36) as plata,sum(poteri_44) as poteri
	   from itog2 group by 1) as a
...
,rezult as
(select  id,date_zap,request_num,
...
union all 
 select  NULL as id,NULL as date_zap,NULL as request_num,
...
/**/
insert into l4_prig.prig_co22_t1 
(id,date_zap,request_num,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,
p21,p22,p23,p24,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34,p35,p36,p37,p38,p39,p40,								 
p41,p42,p43,p44,p45,p46,p47,p48,p49,p50,p51,p52,p53,p54,p55,p56,p57,p58,p59,p60,p61,p62,p63)
select  id,date_zap,request_num,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,
p21,p22,p23,p24,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34,p35,p36,p37,p38,p39,p40,								 
p41,p42,p43,p44,p45,p46,p47,p48,p49,p50,p51,p52,p53,p54,p55,p56,p57,p58,p59,p60,p61,p62,p63
from l4_prig.prig_co22_t0 where p1='tab1';

-----------------
insert into l4_prig.prig_co22_t2(p1,p2,p3,p4,p5,p6,p7)
select  p1,p5 as p2,p2 as p3,d1 as p4,d2 as p5,d3 as p6,d4 as p7
from l4_prig.prig_co22_t0 where p1='tab2';

-----------------
insert into l4_prig.prig_co22_t3(p1,p2,p3,p4,p5,p6,p7)
select  p1,p5 as p2,p2 as p3,d1 as p4,d5 as p5,d6 as p6,d4 as p7
from l4_prig.prig_co22_t0 where p1='tab3';

-----------------
insert into l4_prig.prig_co22_t4
(p1,p2,p3,p4,p5,p6,p7,p8,p9)
select  p1,p5 as p2,p2 as p3,d1 as p4,d2 as p5,d6 as p6,p36 as p7,p44 as p8,d4 as p9
from l4_prig.prig_co22_t0 where p1='tab4';

-----------------
insert into l4_prig.prig_co22_t5(p1,p2,p3,p4,p5,p6,p7,p8,p9,p10)
select 'tab5' as tab_1,a.p5 as kod_vc_2,kol1 as kol1_3,kol2 as kol2_4,kol3 as kol3_5,kol_pas as kol_pas_6,0 as sum_7,0 as sum_8,plata as plata_9,poteri as poteri_10
 from 
 (select p5,count(*) as kol1,sum(p33) as kol_pas,sum(p36) as plata,sum(p44) as poteri
	   from l4_prig.prig_co22_t0 where p1='tab1' group by 1) as a
 join (select p5,count(*) as kol2 from l4_prig.prig_co22_t0 where p1='tab2' group by 1) as b on a.p5=b.p5
 join (select p5,count(*) as kol3 from l4_prig.prig_co22_t0 where p1='tab3' group by 1) as c on a.p5=c.p5
 join (select p5,count(*) as kol4 from l4_prig.prig_co22_t0 where p1='tab4' group by 1) as d on a.p5=d.p5
;

-----------------
insert into l4_prig.prig_co22_t6(p1,p2,p3,p4,p5,p6,p7)
select  p1,p5 as p2,p2 as p3,d1 as p4,d2 as p5,d7 as p6,d4 as p7
from l4_prig.prig_co22_t0 where p1='tab6';
...
--   select * from l4_prig.prig_co22_t6;
...
select p1,sum(p36) as plata,sum(p44) as poteri from l4_prig.prig_co22_t0 group by 1  --проверка приавильности сумм
/*
"tab1"	169280437812	172214434604
"tab4"	169280437780	172214434595
...
select * from
(select p2,sum(case when p1='tab1' then p51 else 0 end) as kol_bil,
sum(case when p1='tab1' then p36 else 0 end) as plata,sum(case when p1='tab4' then p36 else 0 end) as d_plata,
sum(case when p1='tab1' then p44 else 0 end) as poteri,sum(case when p1='tab4' then p44 else 0 end) as d_poteri
from l3_prig.prig_co22_t0 group by 1) as a where plata!=d_plata order by kol_bil
fetch first 100 rows only
--  286089	1	1835	1834	1835	1834


select d1,d4,d6,p36,p44,* from l3_prig.prig_co22_t0 where p2= 286089 and p1 in('tab1','tab4')  order by p1,d1
...
/*
select * from l3_prig.prig_mars where nom_mar in (3) order by nom_mar,nom

select * from l3_prig.prig_mars where /*nom_mar in (3,8,9,17) and*/  id=432136230 order by nom_mar,nom


select * from rawdl2m.l2_prig_main  where id=432136230
...
from rawdl2m.l2_prig_cost where  id=432136230




select  TARIFF_SUM,DEPARTMENT_SUM,*
from rawdl2m.l2_prig_main where  id=432136230



select marshr,* from l3_prig.prig_work where rez in(5,51)

select rez,count(*) as kol from l3_prig.prig_work group by 1


select * from  l3_prig.prig_times order  by date_zap,oper
*/
