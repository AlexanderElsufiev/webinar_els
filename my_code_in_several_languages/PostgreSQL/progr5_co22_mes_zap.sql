...
(yymm dec(7),id bigint,request_num dec(7),date_zap date,
...
(yymm dec(7),request_num dec(7),date_zap date,
 ...
 p41 dec(11),p42 dec(11),p43 dec(11),p44 dec(11),p45 dec(11),p46 dec(11),p47 dec(11),p48 dec(11),p49 dec(11),p50 dec(11),
 p51 dec(9),p52 char(1),p53 char(4),p54 char(7),p55 char(1),p56 char(3),p57 char(1),p58 char(1),p59 char(1),p60 char(3),
 p61 char(1),p62 smallint,p63 char(1),id bigint
) TABLESPACE pg_default;
...
-- select yymm,count(*) as kol from l3_mes.prig_itog group by 1

 -- select p1,count(*) from l3_mes.prig_co22_t0 group by 1

/** /
select * from l3_mes.prig_co22_t5

select * from l3_mes.prig_co22_t1 fetch first 50 rows only

select yymm,count(*) from zzz_rawdl2.l2_prig_main group by 1

select yymm,count(*) as kol from l3_mes.prig_lgotniki group by 1

select count(*) as kol from l3_mes.prig_mars 
...
select count(*) from l3_mes.prig_co22_t0 limit 100

select otd,to_char(otd,'fm00') as otd_,* from l3_mes.prig_mars limit 100


select distinct p5 from l3_mes.prig_co22_t4 limit 100
...
prig1 as
(select nom_str,id,doc_num,request_num,
 case when request_num>0 then date_zap end as date_zap,
 yymm,kol_bil,k_bil,nom_mar,nom_bil,nom_dat,date_beg,date_pr,term_dor,agent,subagent,chp,stp,stp_reg,plata,poteri,kom_sbor,
 dor3,dor_vc
...
(select a.yymm,a.date_zap,
 a.id,a.doc_num,request_num,a.nom_mar,kbil,k_bil,
...
(select yymm,id,request_num,date_zap,nom_mar,kbil,tab_1,--row_number() over (order by nom_str_2_) as nom_str_2, 
 ...
 vid_oforml_52,agent_53,stn_54,abonement_tip_55,srok_abon_56,bag_vid_57,
 flg_zd_fpk_58,flg_zd_fpk_f_59,subagent_60,mcd_61,mcd_rst_62,mcd_vid_63,k_bil
 from --- внутри идёт подсуммирование
(select yymm,request_num,date_zap,nom_mar,kbil,
 ...
 sum(kol_bil_51) as kol_bil_51,sum(k_bil) as k_bil--,count(*) as kol
from itog1 group by yymm,request_num,date_zap,nom_mar,kbil,
 tab_1,year_3,month_4,kod_vc_5,kod_dor_pr_6,kod_dor_of_7,stp_8,chp_9,stp_reg_10,
 stp_okato_11,dt_otp_12,sto_dor_13,sto_otd_14,sto_15,sto_reg_16,sto_oksto_17,sto_nopr_18,kateg_pzd_19,klass_20, 
 vid_bil_21,prizn_pas_22,tarif_23,kod_lgt_24,vid_rasch_25,flg_otch_26,stn_dor_27,stn_otd_28,stn_reg_29,stn_okato_30,
 stn_nopr_31,srasst_32,vid_oforml_52,agent_53,stn_54,abonement_tip_55,srok_abon_56,bag_vid_57,
...
(select yymm,id,date_zap,request_num,nom_mar,kbil,k_bil,tab_1,nom_str_2,  
 year_3,month_4,kod_vc_5,kod_dor_pr_6,kod_dor_of_7,stp_8,chp_9,stp_reg_10,
 stp_okato_11,dt_otp_12,sto_dor_13,sto_otd_14,sto_15,sto_reg_16,sto_oksto_17,sto_nopr_18,kateg_pzd_19,klass_20, 
 vid_bil_21,prizn_pas_22,tarif_23,kod_lgt_24,vid_rasch_25,flg_otch_26,stn_dor_27,stn_otd_28,stn_reg_29,stn_okato_30,
 stn_nopr_31,srasst_32,
...
itog_plat_ as --разбивка денег точная по каждому билету
  (select yymm,nom_mar,nom_reg,dor_vc,nom_str,dor,okato,plata,poteri,--nom_plat,
  ...
  from
  (select yymm,nom_str,term_dor,dor_vc,k_bil,a.nom_mar,nom_plat,nom_pl,nom_reg,reg,dor,okato,rst,sd_plata,s_plata,sd_poteri,s_poteri,s_rst,p_rst,plata,poteri,
  ...
  group by yymm,nom_mar,nom_reg,dor_vc,nom_str,dor,okato,plata,poteri
  ),


/*
itog2_plat_ as  --разбивка денег ПРИБЛИЖЁННАЯ после суммирования бланков!!!
  ...
  from itog2 as a join mar_pl as b on a.nom_mar=b.nom_mar where kbil=1
  ) as b) as c 
...
itog2_plat_ as  --разбивка денег ПРИБЛИЖЁННАЯ после суммирования бланков!!!
  (select yymm,nom_mar,nom_reg,kod_vc_2,nom_str_3,dor,okato,--plata,poteri,--nom_plat,
   ...
   from 
  (select *,
  k_bil*(round(d_plata*s_rst/(p_rst*k_bil))-round(d_plata*(s_rst-rst)/(p_rst*k_bil))) as dd_plata,
  k_bil*(round(d_poteri*s_rst/(p_rst*k_bil))-round(d_poteri*(s_rst-rst)/(p_rst*k_bil))) as dd_poteri
  from
  (select yymm,k_bil,nom_str_2 as nom_str_3,kod_vc_5 as kod_vc_2,a.nom_mar,nom_plat,nom_pl,nom_reg,reg,dor,okato,rst,sd_plata,s_plata,sd_poteri,s_poteri,s_rst,p_rst,--plata,poteri,
   round(plata_36*sd_plata/(s_plata)) as d_plata,round(poteri_44*sd_poteri/(s_poteri)) as d_poteri
  from itog2 as a join mar_pl as b on a.nom_mar=b.nom_mar where kbil=1
  ) as b) as c 
  group by yymm,nom_mar,nom_reg,kod_vc_2,nom_str_3,dor,okato--,plata,poteri
...
,rezult as
(select  yymm,id,date_zap,request_num,
...
union all 
 select  yymm,NULL as id,NULL as date_zap,NULL as request_num,
...
--  (round(d_poteri*s_rst/p_rst)-round(d_poteri*(s_rst-rst)/p_rst)) as dd_poteri
--  from
  (select yymm,kbil,nom_str_2 as nom_str_3,kod_vc_5 as kod_vc_2,a.nom_mar,nom_plat,nom_pl,nom_reg,reg,dor,okato,rst,sd_plata,s_plata,sd_poteri,s_poteri,s_rst,p_rst,--plata,poteri,
   round(plata_36*sd_plata/(s_plata)) as d_plata,round(poteri_44*sd_poteri/(s_poteri)) as d_poteri
  from itog2 as a join mar_pl as b on a.nom_mar=b.nom_mar where kbil=1
  ) 
--   as b) 
--  as c group by yymm,nom_mar,nom_reg,kod_vc_2,nom_str_3,dor,okato--,plata,poteri
-- ),
*/
...
--       select * from  l3_mes.prig_mars order by nom

--  update   l3_mes.prig_mars set reg=78 where nom>10
 --  update   l3_mes.prig_mars set d_plata=NULL,d_poteri=NULL where nom=10

--select * from  l3_mes.prig_itog
...
(yymm,id,date_zap,request_num,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,
p21,p22,p23,p24,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34,p35,p36,p37,p38,p39,p40,								 
p41,p42,p43,p44,p45,p46,p47,p48,p49,p50,p51,p52,p53,p54,p55,p56,p57,p58,p59,p60,p61,p62,p63)
select  yymm,id,date_zap,request_num,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,
p21,p22,p23,p24,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34,p35,p36,p37,p38,p39,p40,								 
p41,p42,p43,p44,p45,p46,p47,p48,p49,p50,p51,p52,p53,p54,p55,p56,p57,p58,p59,p60,p61,p62,p63
...
--   select * from l3_mes.prig_co22_t0 limit 100
...
/*  --выдача итогов на печать
 ...
 select * from l3_mes.prig_co22_t2 order by p3,p4;
 select * from l3_mes.prig_co22_t3 order by p3,p4;
 select * from l3_mes.prig_co22_t4 order by p3,p4; -- ошибка расстояние задвоилось
 select * from l3_mes.prig_co22_t6 order by p3,p4;
 
 
  select count(*) from l3_mes.prig_co22_t0;
