...
select * from l3_mes.prig_analit where date='2023-04-09' and  agent=15 and chp=15 and par_name='prod' order by plata
limit 10




select * from l3_mes.prig_itog where part_zap=149
