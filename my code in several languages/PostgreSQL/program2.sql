...
from rawdl2m.l2_prig_main   where REQUEST_DATE  in (select date_zap from date)
...
from rawdl2m.l2_prig_cost where REQUEST_DATE in(select date_zap from date) 
...
prig_cost3 as  --- 372098 zap  39sek
