...
/*  --выдача итогов на печать
 select * from l3_prig.prig_co22_t1 order by p2 ;
 select * from l3_prig.prig_co22_t2 order by p3,p4;
 select * from l3_prig.prig_co22_t3 order by p3,p4;
 select * from l3_prig.prig_co22_t4 order by p3,p4; 
 select * from l3_prig.prig_co22_t5;
 select * from l3_prig.prig_co22_t6 order by p3,p4;

*/


--select * from l3_prig.prig_co22_t1 where request_num in(  9730 , 28276      )  order by p2 ;

/*
delete from l3_prig.prig_co22_t0;
delete from l3_prig.prig_co22_t1;
delete from l3_prig.prig_co22_t2;
delete from l3_prig.prig_co22_t3;
delete from l3_prig.prig_co22_t4;
delete from l3_prig.prig_co22_t5;
delete from l3_prig.prig_co22_t6;
*/

/* СОЗДАНИЕ ТАБЛИЦ ОТЧЁТА ЦО-22	* /
DROP TABLE l3_prig.prig_co22_t0;
DROP TABLE l3_prig.prig_co22_t1;
DROP TABLE l3_prig.prig_co22_t2;
DROP TABLE l3_prig.prig_co22_t3;
DROP TABLE l3_prig.prig_co22_t4;
DROP TABLE l3_prig.prig_co22_t5;
DROP TABLE l3_prig.prig_co22_t6;



-------------------------------

CREATE TABLE l3_prig.prig_co22_t0
...
ALTER TABLE l3_prig.prig_co22_t0 OWNER to asul;
GRANT ALL ON TABLE l3_prig.prig_co22_t0 TO asul;

-------------------------------
CREATE TABLE l3_prig.prig_co22_t1
...
ALTER TABLE l3_prig.prig_co22_t1 OWNER to asul;
GRANT ALL ON TABLE l3_prig.prig_co22_t1 TO asul;

-----------------------------
CREATE TABLE l3_prig.prig_co22_t2
(yymm dec(7),p1 char(4),p2 char(3),p3 integer,p4 smallint,p5 char(3),p6 char(2),p7 smallint
) TABLESPACE pg_default;
ALTER TABLE l3_prig.prig_co22_t2 OWNER to asul;
GRANT ALL ON TABLE l3_prig.prig_co22_t2 TO asul;


------------------------------
CREATE TABLE l3_prig.prig_co22_t3
(yymm dec(7),p1 char(4),p2 char(3),p3 integer,p4 smallint,p5 char(2),p6 char(5),p7 smallint
) TABLESPACE pg_default;
ALTER TABLE l3_prig.prig_co22_t3 OWNER to asul;
GRANT ALL ON TABLE l3_prig.prig_co22_t3 TO asul;


------------------------------
CREATE TABLE l3_prig.prig_co22_t4
(yymm dec(7),p1 char(4),p2 char(3),p3 integer,p4 smallint,p5 char(3),p6 char(5),p7 dec(11),p8 dec(11), p9 smallint
) TABLESPACE pg_default;
ALTER TABLE l3_prig.prig_co22_t4 OWNER to asul;
GRANT ALL ON TABLE l3_prig.prig_co22_t4 TO asul;


------------------------------
CREATE TABLE l3_prig.prig_co22_t5
(yymm dec(7),p1 char(4),p2 char(3),p3 integer,p4 integer,p5 integer,p6 dec(13),p7 dec(15),p8 dec(15),p9 dec(15),p10 dec(15)
) TABLESPACE pg_default;
ALTER TABLE l3_prig.prig_co22_t5 OWNER to asul;
GRANT ALL ON TABLE l3_prig.prig_co22_t5 TO asul;


------------------------------
CREATE TABLE l3_prig.prig_co22_t6
(yymm dec(7),p1 char(4),p2 char(3),p3 integer,p4 smallint,p5 char(2),p6 integer,p7 smallint
) TABLESPACE pg_default;
ALTER TABLE l3_prig.prig_co22_t6 OWNER to asul;
GRANT ALL ON TABLE l3_prig.prig_co22_t6 TO asul;
...
-- select yymm,count(*) as kol from l3_prig.prig_itog group by 1

 -- select p1,count(*) from l3_prig.prig_co22_t0 group by 1

/** /
select * from l3_prig.prig_co22_t5

select * from l3_prig.prig_co22_t1 fetch first 50 rows only

select yymm,count(*) from zzz_rawdl2.l2_prig_main group by 1

select yymm,count(*) as kol from l3_prig.prig_lgotniki group by 1

select count(*) as kol from l3_prig.prig_mars 



select * from nsi.lgot fetch first 50 rows only


select * from nsi.lgotgr fetch first 500 rows only
...
/*
select * from l3_prig.prig_co22_t1 limit 100


select count(*) from l3_prig.prig_co22_t0 limit 100

select otd,to_char(otd,'fm00') as otd_,* from l3_prig.prig_mars limit 100


select distinct p5 from l3_prig.prig_co22_t4 limit 100

*/


--ERROR: ОШИБКА:  переполнение поля numeric
--DETAIL:  Поле с точностью 11, порядком 0 должно округляться до абсолютного значения меньше чем 10^11.
...
select count(*) from l3_mes.prig_co22_t1;


select * from l3_mes.prig_co22_t6;




select  yymm,count(*) from l3_prig.prig_itog group by 1 order by 1


select  yymm,count(*) from l3_mes.prig_itog group by 1 order by 1
2301	196820
2302	1948773
2303	19
2304	865342
...
--- ТАБЛИЦА 1
insert into l3_prig.prig_co22_t0 
...
join bil as d on a.nom_bil=d.nom_bil --119
 ...
 select count(*),max(nom_mar) from l3_prig.prig_mars
 */
...
insert into l3_prig.prig_co22_t1 
...
p21,p22,p23,p24,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34,p35,p36,p37,p38,p39,p40,								 
p41,p42,p43,p44,p45,p46,p47,p48,p49,p50,p51,p52,p53,p54,p55,p56,p57,p58,p59,p60,p61,p62,p63
from l3_prig.prig_co22_t0 where p1='tab1';

-----------------
insert into l3_prig.prig_co22_t2(yymm,p1,p2,p3,p4,p5,p6,p7)
select yymm,p1,p5 as p2,p2 as p3,d1 as p4,d2 as p5,d3 as p6,d4 as p7
from l3_prig.prig_co22_t0 where p1='tab2';

-----------------
insert into l3_prig.prig_co22_t3(yymm,p1,p2,p3,p4,p5,p6,p7)
select yymm,p1,p5 as p2,p2 as p3,d1 as p4,d5 as p5,d6 as p6,d4 as p7
from l3_prig.prig_co22_t0 where p1='tab3';

-----------------
insert into l3_prig.prig_co22_t4
(yymm,p1,p2,p3,p4,p5,p6,p7,p8,p9)
select yymm,p1,p5 as p2,p2 as p3,d1 as p4,d2 as p5,d6 as p6,p36 as p7,p44 as p8,d4 as p9
from l3_prig.prig_co22_t0 where p1='tab4';

-----------------
insert into l3_prig.prig_co22_t5(yymm,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10)
select yymm,'tab5' as tab_1,a.p5 as kod_vc_2,kol1 as kol1_3,kol2 as kol2_4,kol3 as kol3_5,kol_pas as kol_pas_6,0 as sum_7,0 as sum_8,plata as plata_9,poteri as poteri_10
 ...
 (select yymm,p5,count(*) as kol1,sum(p33) as kol_pas,sum(p36) as plata,sum(p44) as poteri
	   from l3_prig.prig_co22_t0 where p1='tab1' group by 1,2) as a
 join (select p5,count(*) as kol2 from l3_prig.prig_co22_t0 where p1='tab2' group by 1) as b on a.p5=b.p5
 join (select p5,count(*) as kol3 from l3_prig.prig_co22_t0 where p1='tab3' group by 1) as c on a.p5=c.p5
 join (select p5,count(*) as kol4 from l3_prig.prig_co22_t0 where p1='tab4' group by 1) as d on a.p5=d.p5
;

-----------------
insert into l3_prig.prig_co22_t6(yymm,p1,p2,p3,p4,p5,p6,p7)
select yymm,p1,p5 as p2,p2 as p3,d1 as p4,d2 as p5,d7 as p6,d4 as p7
from l3_prig.prig_co22_t0 where p1='tab6';
...
--   select * from l3_prig.prig_co22_t5 limit 100




/*  --выдача итогов на печать
 select * from l3_prig.prig_co22_t1 where yymm=2309 order by p2 ;
 select * from l3_prig.prig_co22_t2 where yymm=2309 order by p3,p4;
 select * from l3_prig.prig_co22_t3 where yymm=2309 order by p3,p4;
 select * from l3_prig.prig_co22_t4 where yymm=2309 order by p3,p4; -- ошибка пустые значения суммм
 select * from l3_prig.prig_co22_t5 where yymm=2309;
 select * from l3_prig.prig_co22_t6 where yymm=2309 order by p3,p4;
...
/*
select * from l3_prig.prig_co22_t1 where yymm=2308

select distinct date_zap,yymm from l3_prig.prig_co22_t0 order by 1,2
*/
